  ...
  if(vagas.length === 0) {
    return (
      <div className='flex flex-col items-center justify-center gap-10 my-3'>
          ...
          <p className='text-sm mb-3'>Aguardando vagas...</p>
  ...
  return (
    <>
      <div className='w-[80% mx-auto flex flex-col justify-center items-center rounded-lg md:mx-0 md:w-auto ml-2 mr-2'>
        <h2 className="text-base md:text-3xl font-mono md:font-semibold flex text-start mr-auto ml-2">Vagas encerradas:</h2>
        {vagas.map((vaga) => (
          vaga.status !== "Aberta" && (
